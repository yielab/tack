...
| 6 — Legacy bridge and release | III-G1 · G2 · G3 · G4 · G5 | 57 | unblocked — ready to dispatch. All six product waves (0–5) are accepted (Wave 5 at `073aa4d`); the "blocked on all product gates" status recorded here no longer applies. Cards branch from `5c6842f` (`agent/iii-f6-integration`, identical to `plan/harness-agnostic-agent-fleet`). III-G1–G4 may run in parallel; III-G5 is the final integrator and must run last, after G1–G4 land. |
