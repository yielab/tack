...
report "AI attribution" \
  "This project does not attribute code to a model, in comments or anywhere else." \
  "$(commentish '\b(Claude|Anthropic|GPT|Copilot|generated by an? (AI|model|agent))\b')"
