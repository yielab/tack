> Archived, no-longer-current roadmap content — Phases 58–63 (Standalone Single-Binary Operation through Human maintainability). The live roadmap is `docs/book/src/roadmap.md`.
