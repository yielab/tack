...
| **M5** | Harness core: card T0 of `docs/closed-cycles/plans/harness-maintainability-audit.md`, unchanged. Runs after M1 because it edits files M1 moves. | agent | `package(tack-runner)` + crash matrix | −2 000 lines, four lifecycle copies → one |
